...
namespace Kamgam.UVEditor
{
    public static class MeshUtils
    {
		...
		[MenuItem("Tools/UV Editor/Debug/Smooth Normals", priority = 201)]
		...
		[MenuItem("Tools/UV Editor/Debug/Recalculate Normals", priority = 200)]
		...
		[MenuItem("Tools/UV Editor/Debug/Invert Normals", priority = 203)]
        ...
        [MenuItem("Tools/UV Editor/Debug/Show Normals/0.01", priority = 204)]
        public static void DebugNormals0p01()
        {
            debugNormals(0.01f);
        }

        [MenuItem("Tools/UV Editor/Debug/Show Normals/0.1", priority = 204)]
		public static void DebugNormals0p1()
		{
            debugNormals(0.1f);
        }

        [MenuItem("Tools/UV Editor/Debug/Show Normals/1", priority = 205)]
        public static void DebugNormals1()
        {
            debugNormals(1f);
        }

        [MenuItem("Tools/UV Editor/Debug/Show Normals/10", priority = 206)]
