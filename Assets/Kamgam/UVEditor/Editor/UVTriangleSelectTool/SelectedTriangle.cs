...
namespace Kamgam.UVEditor
{
    public class SelectedTriangle : IEquatable<SelectedTriangle>
    {
        ...
        {
            return obj != null && Component == obj.Component && SubMeshIndex == obj.SubMeshIndex && TriangleIndices == obj.TriangleIndices;
        }

        public override int GetHashCode()
        {
            if (Mesh == null || Component == null)
                return 0;
            
            return Component.GetHashCode() ^ SubMeshIndex.GetHashCode() ^ TriangleIndices.GetHashCode();
        }
